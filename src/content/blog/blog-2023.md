---
author: matac
pubDatetime: 2023-12-06T20:50:05.000Z
...
ドメインをFC2からRoute53に移した。結構面倒だった。

## 3月

- [EC2インスタンスを増やしたり減らしたりしたい](/posts/ec2)
- [Terraformでドメイン周りのapply & destroyを繰り返したときに発生した問題](/posts/terraform-route53-apply-destroy)
- [Terraformでドメインと証明書取得をしたい](/posts/terraform)

この辺りではTerraformにハマっていた。
...
6、7月はブログ書いてなかったみたい。なんでだ？まあいいか。
この月で就活完了した。
多分他の人たちと比べると結構遅かった？
「就活完了した」の記事からは毎日ブログを書くようにしたので、
ここからブログの本数が多くなる。
一応、今日まで途切れずに毎日書き続けることができている。
...
多いな。なんか色々やってる。一番多いのはガベージコレクション関係かな。
...
Beatmaniaはずっとやってるね。この月はRESIDENTが稼働終了した月だ。
...
先月のことなので見直すことはあまりないかな。
弐寺SP九段合格したのは嬉しかった。
なんかご飯の話が多い気がする。カレーパーティー楽しかった。
